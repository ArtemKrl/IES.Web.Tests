...
def ambulance_select(driver: webdriver):
    ...
    time.sleep(2)
    driver.find_element_by_css_selector('div:nth-child(7) > div > button').click()
    ...
    time.sleep(1)
    driver.find_element_by_css_selector("div.ReactVirtualized__Table__row:nth-child(1)").click()  # select type of
    # selection
    ...
    time.sleep(1)
    driver.find_element_by_css_selector("div.ReactVirtualized__Table__row:nth-child(1)").click()  # select
    # type of SMO
